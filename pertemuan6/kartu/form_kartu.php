  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <div class="col-8">
        <input id="kode" name="nama" type="text" class="form-control"
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="diskon" name="diskon" value="<?php if(isset($row['diskon'])) echo $row['diskon']; ?>" type="number" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
